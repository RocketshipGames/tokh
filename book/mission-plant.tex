...
%  \end{squishitemize}
  ...
  \colorbox{Gray!24}{\begin{minipage}{\linewidth-2\fboxsep}
      ...
      \item Bombs count as placed for scoring whether they are
        camouflaged or not.

      \item Deployed Bombs are targetable equipment with the following profile:
...
\cfbox{LimeGreen}{\begin{minipage}{6.5in}
  ...
  \colorbox{Gray!24}{\begin{minipage}{\linewidth-2\fboxsep}
      ...
      \item The marker must be placed in base contact with or on one
        of the player's chosen pieces of Vulnerable Infrastructure, in
        base contact with the user or, in its Active Turn, any part of
        its route if it moved.
      \end{squishitemize}
  \end{minipage}}
\end{minipage}}}
